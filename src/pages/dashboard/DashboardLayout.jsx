...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex relative">
        ...
        <aside className="w-64 border-r border-border bg-card/50 flex flex-col fixed top-0 left-0 bottom-0 z-40">
          <div className="p-4 border-b border-border flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-bold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent">JobVerse</span>
            </Link>
            <button
      ...
      {/* Menu Button - Floating, doesn't affect layout */}
      {!sidebarOpen && (
        <button
